...
permission:
  ...
  bash:
    ...
    "python3 .opencode/tools/subtranslate_b4_recovery_call.py --apply": allow
...
`python3 .opencode/tools/subtranslate_readonly_probe.py`
...
`python3 .opencode/tools/subtranslate_b4_post_execution_reconcile.py --plan`.
...
`python3 .opencode/tools/subtranslate_recovery_ledger_reprepare.py --apply`
