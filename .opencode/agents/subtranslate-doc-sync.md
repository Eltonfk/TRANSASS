...
permission:
  ...
  bash:
    "*": deny
    "python3 .opencode/tools/subtranslate_canonical_backup.py --run": allow
    "python3 .opencode/tools/subtranslate_canonical_transition.py --mode record-preflight": allow
    "python3 .opencode/tools/subtranslate_canonical_transition.py --mode record-authorization": allow
    "python3 .opencode/tools/subtranslate_canonical_transition.py --mode record-post-execution": allow
    "python3 .opencode/tools/subtranslate_canonical_transition.py --mode record-failure": allow
    "python3 .opencode/tools/subtranslate_canonical_transition.py --mode record-track2-live-captured-decision": allow
    "python3 .opencode/tools/subtranslate_b4_post_execution_reconcile.py --plan": allow
    "python3 .opencode/tools/subtranslate_b4_post_execution_reconcile.py --apply": allow
  task: deny
  webfetch: deny
  websearch: deny
---
