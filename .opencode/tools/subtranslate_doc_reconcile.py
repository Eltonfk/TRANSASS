...
RECONCILIATION_KEY = "auto03e_season_final_reconciliation_r1"
TARGET_LATEST_DECISION = "SEASON_E07_E12_COMPLETE_ALL_BATCHES_RESOLVED_MULTI_MOTOR_V240"
TARGET_NEXT_ACTION = "SEASON_E07_E12_COMPLETE_HUMAN_REVIEW_AND_RELEASE_DECISION_REQUIRED"
...
def build_additive_object(now: str, fingerprint: str) -> dict[str, Any]:
    return {
        "mode": "SEASON_FINAL_RECONCILIATION",
        "recorded_at": now,
