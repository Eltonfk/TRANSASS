...
cp "$root/desktop/packaging/linux/transass.desktop" "$appdir/usr/share/applications/transass.desktop"
cp "$root/desktop/packaging/linux/transass.desktop" "$appdir/transass.desktop"
