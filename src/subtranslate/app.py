...
<body><main>
<header class="top"><div><h1>Tradutor de Legendas</h1><div class="muted">Fila segura de episódios · sem sobrescrever PT-BR existente</div></div><div class="chips"><span class="chip" id="pipelineChip">Pipeline…</span><span class="chip" id="modelChip">Modelo…</span><span class="chip online" id="serviceChip">Serviço…</span></div></header>
<div class="grid">
...
function recordLabel(record){return record.pipeline_version||((record.source_kind||'').toUpperCase()==='IMPORTED_EXISTING'?'Versão legada':'Pipeline desconhecido')}
