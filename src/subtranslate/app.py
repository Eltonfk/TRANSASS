...
<body><main>
<header class="top"><div><h1>Tradutor de Legendas</h1><div class="muted">Fila segura de episódios · sem sobrescrever PT-BR existente</div></div><div class="chips"><span class="chip" id="pipelineChip">Pipeline…</span><span class="chip" id="modelChip">Modelo…</span><span class="chip" id="motorChip" title="Motor de tradução configurado">Motor…</span><span class="chip online" id="serviceChip">Serviço…</span><button class="button" id="openTransportConfig" style="margin-left:8px">⚙ Motor</button></div></header>
<div class="grid">
